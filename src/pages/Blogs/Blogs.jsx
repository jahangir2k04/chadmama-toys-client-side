...
const Blogs = () => {
    useTitle('Blogs');
    return (
        <div className="max-w-5xl mx-auto p-2 my-5 md:my-10">
            <div className="my-10 space-y-3">
                <h2 className="text-2xl md:text-5xl font-bold mb-5">* What is an access token and refresh token? How do they work and where should we store them on the client-side?</h2>
                <p className="text-lg md:text-2xl text-gray-600">
                    -- Access token is a short-lived token that is used to request permission to access protected resources. <br />
                    The client includes the access token in each request to the server to access protected resources or perform authorized actions. That have an expiration time. When an access token expires, the client needs to obtain a new one.
            ...
            <div className="my-10 space-y-3">
                <h2 className="text-2xl md:text-5xl font-bold mb-5">* Compare SQL and NoSQL databases?</h2>
                <p className="text-lg md:text-2xl text-gray-600">
                    -- Type :<br />
            ...
            <div className="my-10 space-y-3">
                <h2 className="text-2xl md:text-5xl font-bold mb-5">* What is express js? What is Nest JS?</h2>
                <p className="text-lg md:text-2xl text-gray-600">
            ...
            <div className="my-10">
                <h2 className="text-2xl md:text-5xl font-bold mb-5">* What is MongoDB aggregate and how does it work?</h2>
                <p className="text-lg md:text-2xl text-gray-600">
